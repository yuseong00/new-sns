...
public class PostControllerTest {
    ...
    @Test
    @WithMockUser  //게시글 리스트를 끌고 올거니까 따로 필요없다.
    ...
    @Test
    @WithAnonymousUser
    void 피드목록_로그인하지_않은경우() throws Exception {
        when(postService.list(any())).thenReturn(Page.empty());
    ...
    @Test
    @WithAnonymousUser
    void 내_피드목록_로그인하지_않은경우() throws Exception {
        when(postService.my(any(),any())).thenReturn(Page.empty());
    ...
    @Test
    @WithAnonymousUser
    void 댓글작성시시_게시물이_없는경우() throws Exception {
